...
if(@intersection_id='A' and @tollgate_id='2')--與A2路段
select intersection_id,tollgate_id,@A2平均時速 as 平均時速 from [dbo].[routes (table 4)]
where intersection_id=@intersection_id and tollgate_id=@tollgate_id
if(@intersection_id='A' and @tollgate_id='3')--與A3路段
select intersection_id,tollgate_id,@A3平均時速 as 平均時速 from [dbo].[routes (table 4)]
where intersection_id=@intersection_id and tollgate_id=@tollgate_id
if(@intersection_id='B' and @tollgate_id='1')--與B1路段
select intersection_id,tollgate_id,@B1平均時速 as 平均時速 from [dbo].[routes (table 4)]
where intersection_id=@intersection_id and tollgate_id=@tollgate_id
if(@intersection_id='B' and @tollgate_id='3')--與B3路段
select intersection_id,tollgate_id,@B3平均時速 as 平均時速 from [dbo].[routes (table 4)]
where intersection_id=@intersection_id and tollgate_id=@tollgate_id
if(@intersection_id='C' and @tollgate_id='1')--與C1路段
select intersection_id,tollgate_id,@C1平均時速 as 平均時速 from [dbo].[routes (table 4)]
where intersection_id=@intersection_id and tollgate_id=@tollgate_id
if(@intersection_id='C' and @tollgate_id='3')--與C3路段
select intersection_id,tollgate_id,@C3平均時速 as 平均時速 from [dbo].[routes (table 4)]
where intersection_id=@intersection_id and tollgate_id=@tollgate_id
